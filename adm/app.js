...
app.use('/contact-site', contacts);
app.use('/contact-site/edit', contacts);

app.use('/footer-site', footer);
app.use('/footer-site/edit', footer);

app.use('/contacts-msgs', contactsMsgs);
app.use('/contacts-msgs/view', contactsMsgs);

app.use('/situations-abouts-site', situationsAbouts);
app.use('/situations-abouts-site/view', situationsAbouts);
...
app.use('/abouts-companies-site/view', aboutsCompanies);
